...
public class OrderController {
    ...
    public OrderController(OrderService orderService, CartService cartService, OrderProService orderProService, BookService bookService) {
    ...
    @GetMapping( "/{cartId}")
	public String requestCartList(@PathVariable(value = "cartId") String cartId, Model ignoredModel) {
	...
	public String requestCustomerInfo( @ModelAttribute Customer  customer, Model ignoredModel) {
	...
	public String requestCancelled(HttpServletRequest request ) {	
	    ...
	    @GetMapping("/list2")
		public String requestOrderList(Model ignoredModel) {
		   return "orderList";
		}
